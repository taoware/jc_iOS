...
@interface GXAdminAdminViewController () <UICollectionViewDelegate, UICollectionViewDataSource>
@property (nonatomic, strong)UICollectionView* collectionView;
@end

@implementation GXAdminAdminViewController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell
    cell.imageView.image = [UIImage imageNamed:@"adminAdminIcon.png"];
