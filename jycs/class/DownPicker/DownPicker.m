...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    if ([self.delegate respondsToSelector:@selector(didPickItemAtIndex:)]) {
        [self.delegate didPickItemAtIndex:row];
    }
}
...
-(void)doneClicked:(id) sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(didPickItemAtIndex:)]) {
        [self.delegate didPickItemAtIndex:[pickerView selectedRowInComponent:0]];
    }
}
