//
//  GXAdminEmplyeeViewController.m
//  jycs
//
//  Created by appleseed on 3/6/15.
...
@interface GXAdminEmplyeeViewController () <UICollectionViewDelegate, UICollectionViewDataSource>
@property (nonatomic, strong)UICollectionView* collectionView;
@end

@implementation GXAdminEmplyeeViewController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell
    cell.imageView.image = [UIImage imageNamed:@"adminEmpolyeeIcon.png"];
