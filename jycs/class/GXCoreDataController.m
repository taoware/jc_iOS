...
@interface GXCoreDataController ()
...
@implementation GXCoreDataController
...
+ (id)sharedInstance {
    ...
    static GXCoreDataController *sharedInstance;
    dispatch_once(&once, ^{
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"jycsCD" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"jycs.sqlite"];
    NSLog(@"%@", storeURL);
    NSError *error = nil;
